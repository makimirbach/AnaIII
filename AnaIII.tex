...
$$\hat f: \mathbb R^n \rightarrow \mathbb C,\quad  \hat f(\gamma) = (2\pi)^{-\dfrac{n}{2}} \int_{\mathbb R^n} f(x) e^{-i\langle \gamma, x \rangle} \; d\mathscr L^n(x)$$
...
\begin{enumerate}
	...
	\item $\hat {\ffg} = \hat f \;\hat g \;(2\pi)^{\dfrac{n}{2}}$
...
\begin{enumerate}
	...
	\item Für $a >0$ betrachte $\chi_{[-a, a]}: \mathbb R \rightarrow \mathbb Rn \in L^1(\mathbb R)$ 
	$$\hat {\chi_{[-a, a]}} (\gamma) \;= \;(2\pi)^{-1/2} \int_ \mathbb R \chi_{[-a, a]} (x) e^{-i x \gamma} \; d\mathscr L^1(x)$$
	\begin{equation}
